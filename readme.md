...
## By [`zer0Kerbal`][zer0Kerbal], originally by [`CliftonM`][cliftonm]
...
* Angular (90° degree angle)
  * surface and bottom attach (one nodes)
  * omni decoupler
  * 0.2m thick
  * three (3) sizes
    * 0.25m x 0.25m
...
* Circular
  ...
  * 0.2m thick
  * three (3) sizes
    * 0.625m (size0) diameter
    * 1.25m (size1) diameter
    * 2.5m (size2) diameter
* Rectangular (0.2m thick)
  * surface and bottom attach (one nodes)
  * omni decoupler
  * three (3) sizes
  * 0.2m thick
...
* Square
  ...
  * three (3) sizes
    ...
    * 2.0m x 2.0m
* Popup
  * surface, top and bottom attach (two nodes)
  * omni decoupler
  * *yes, it really does "pop-up" and even "pop-down"*
  * five (5) sizes
  * 0.625m (size0)
  * 1.25m (size1)
  * 1.875m (size1p5)
...
* Cube
  * one size
* Probe
  * 1.875 heat resistant probe with all the mod-cons!
  * *yes, a very, Very, VERY heat resistant probe core*
...
### Help Wanted
>
> * Would love to see a hexagon shaped tile 0.2mm thick!
...
* [CliftonM][cliftonm] for creating this glorious add-on!
...
#### Original (0) - Author: [`CliftonM`][cliftonm]
...
[MOD:issue]: https://github.com/zer0Kerbal/RadialHeatShields/issues "GitHub Issues"
...
[AVCVLD:shd]: https://github.com/zer0Kerbal/RadialHeatShields/workflows/Validate%20AVC%20.version%20files/badge.svg?labelColor=black&style=plastic "AVC-Valid - thank you to DasSkelett"
...
[GITHUB:url]: https://github.com/zer0Kerbal/RadialHeatShields/ "GitHub"
[GITHUB:shd]: https://img.shields.io/badge/Github-Listed-white.svg?labelColor=181717&style=plastic&logo=github "GitHub"

[SPCDCK:url]: http://spacedock.info/mod/2988 "SpaceDock"
